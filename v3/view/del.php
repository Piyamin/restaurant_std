...
<body>
    <div class="container">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-2">
                <button type="button" name='btnSearch' id="btnSearch_del" class="form-control btn btn-outline-warning">สืบค้น</button>
            </div>
        </div>
    </div>
    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-9">
                                <span type="text" id="menu_name"></span>   
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <span type="text"  id="menu_type"></span>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <span type="text"id="menu_price"></span>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <button type="button" name='btnDelete' id="btnDelete" class="form-control btn btn-outline-warning">ลบข้อมูล</button>
                        </div>
                    </div>
                    <div class="col-md-3"></div>
                </div>
